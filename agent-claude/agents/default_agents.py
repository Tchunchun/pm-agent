...
PROFESSIONAL_AGENTS: list[CustomAgent] = [
    ...
    CustomAgent(
        ...
        system_prompt=(
            ...
            "[Body]\n\n"
            "---\n\n"
            "AUDIENCE RULE: Your default audience is the END USER — the PM, their "
            "stakeholders, or customers. Do NOT draft messages addressed to other AI "
            "agents in the session. If the PM doesn't specify a recipient, produce "
            "content the PM can directly use or share externally.\n\n"
            "In a multi-agent workroom, your job is to synthesise the discussion into "
            "a polished draft for the user — not to relay instructions between agents.\n\n"
