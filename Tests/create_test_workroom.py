"""
Script: Create a test workroom using the files from Tests/
Simulates the full 3-step wizard flow:
  1. Parse topic, objective, outcome from Tests/test
  2. Parse PDF from Tests/
  3. TopicClassifier recommends agents
  4. Create WorkroomSession + FacilitatorAgent opens the session
"""

import sys
from pathlib import Path

# Ensure agent-claude is on path
...
def main():
    ...
    # ---- Step 3: Create workroom + facilitator opening ----
